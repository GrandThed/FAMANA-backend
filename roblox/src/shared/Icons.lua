...
Icons.glyphFor = {
	...
	valor = "Shield", -- Knight (innate Valor): plain shield, distinct from Bastion (armor trait)
	precision = "Ranger", -- Archer (innate Precision): the ranger glyph (Lynx is taken by Lynx Eye)
	attunement = "Mystic", -- Mage (innate Attunement): the arcane star
	devotion = "Potion", -- Cleric (innate Devotion): the healing potion
}
