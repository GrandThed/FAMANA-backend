...
export async function savePlayer(playerId, { health, gold, level, xp, currentClass, classLevels, hotbarBinds, settings, questProgress, trackedQuestId, cell, position }) {
  const sets = [];
  const params = [];
  let i = 1;
